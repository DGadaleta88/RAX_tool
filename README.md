...
**RAXpy, a GUI implementation of the workflow based on Python is availabe here (https://bitbucket.org/giolavado/raxpy/src/master/) and on the VAGA HUB website (https://www.vegahub.eu/portfolio-item/raxpy/) for download.**
